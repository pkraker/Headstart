...
<html>
    ...
    <body style="margin:0px; padding:0px">
        ...
        <script type="text/javascript">
         ...
         <div style="margin-top:20px">Built with <a href="http://github.com/OpenKnowledgeMaps/Headstart" target="_blank">Headstart</a>. All content retrieved from <a href="https://www.gotriple.eu/" target="_blank ">TRIPLE</a>.
        </div>
    </body>
</html>
