...
get_or_create_nouns_async <- function(docs, index, lang) {
  ...
  if (length(nc_null) > 0) {
    nc_fill <- create_nouns_batch(paste(docs$title, docs$paper_abstract, docs$subject, sep=". "), lang=lang)
...
get_or_create_ne_async <- function(docs, index, lang) {
  ...
  if (length(ne_null) > 0) {
    ne_fill <- create_ne_batch(paste(docs$title, docs$paper_abstract, docs$subject, sep=". "), lang=lang)
